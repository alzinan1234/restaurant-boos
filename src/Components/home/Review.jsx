...
const Review = () => {
  ...
  useEffect(() => {
    const fetchReviews = async () => {
      try {
        const response = await fetch("../../../public/reviews.json"); // Correct path to public folder
    ...
    <div className="p-8">
      <Splide
        options={{
          ...
          arrows: !isLoading, // Disable arrows while loading
          ...
          <SplideSlide key={review._id}>
            <div className="bg-white p-6 rounded-lg shadow-lg w-full sm:w-11/12 md:w-3/4 lg:w-2/3 xl:w-1/2 mx-auto">
              <div className="mt-4 text-6xl flex flex-col justify-center items-center gap-6">
                ...
                <div>
                  <p className="text-sm text-gray-500 mt-2">{review.details}</p>
      ...
      {/* Custom arrows, disabled while loading */}
